...
export function OrdersProvider({ children, initialOrders, initialNow }: OrdersProviderProps) {
	...
	const contextValue = useMemo<OrdersContextProps>(
		...
		[orders, now, isLoading, isPending, isConnected, error, socketError, updateStatus, createOrder, updateOrder]
	);
